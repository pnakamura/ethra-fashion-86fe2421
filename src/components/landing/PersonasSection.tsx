      ...
      <div className="max-w-6xl mx-auto">
        ...
        duration: 0.6
          ...
          <h2 className="font-display text-4xl md:text-5xl font-semibold mb-4">
            Para quem é
            <br />
            <span className="text-gradient">a Ethra?</span>
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {personas.map((persona, index) => <motion.div key={persona.title} className="group relative p-6 rounded-2xl bg-card border border-border/50 hover:border-primary/30 transition-all duration-300 text-center" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
