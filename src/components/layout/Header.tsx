...
export function Header({ title }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-background/95 dark:bg-background/98 backdrop-blur-xl border-b border-border dark:border-b-[hsl(42_85%_55%_/_0.18)] dark:shadow-[0_1px_20px_hsl(42_85%_55%_/_0.08)]">
